...
#DATA_DIR = "/content/drive/MyDrive/science_work/DAN_TEST1/"
DATA_DIR = "/content/drive/MyDrive/DAN/"
...
if __name__ == "__main__":
    ...
    default_digit_data_file = DATA_DIR + "configs/datasets/digits_mnist_usps.json"
    ...
    parser.add_argument(
        ...
        type=str,
        default=default_digit_data_file,
    )
    parser.add_argument(
        "-m",
        "--method",
        ...
        type=str,
        default=DATA_DIR + "configs/dan_method.json",
    )
    parser.add_argument(
        "--nseeds",
    ...
    network_config_file = DATA_DIR + f"/configs/{data_name}_network.json"
